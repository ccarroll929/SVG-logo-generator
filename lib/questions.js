// Grab colorKeywords array to check if user input is a valid color choice
...
const questions = [
    ...
    // Validate color input is an option in colorKeywords array
    {
        type: "input",
        name: "shapeColor",
    ...
    // Validate user text input is 3 characters or less
    {
        name: 'text',
